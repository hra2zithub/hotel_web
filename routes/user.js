...
route.get("/book_metting_events/:event_hall_id",async function(req,res){
    ...
    var hotel_data=await exe(`select * from basic_information`);
    res.render("user/book_metting_events.ejs",{"hotel_data":hotel_data,"event_hall_data":event_hall_data})
})
...
route.get("/order_food_data/:dis_id",async function(req,res){
    ...
    res.render("user/order_food_data.ejs",{"hotel_data":hotel_data,"order_data":order_data})
})
route.post("/save_order_food_data",async function(req,res){
    ...
    var sql=`insert into order_food_data (client_name,client_email,client_number,dish_name,dish_price,order_status,order_date,order_time) values ("${req.body.client_name}","${req.body.client_email}","${req.body.client_number}","${req.body.dish_name}","${req.body.dish_price}","pending","${date_obj}","${time_obj}")`;
    var data=await exe(sql)
...
route.get("/book_wines/:wines_id",async function(req,res){
    ...
    res.render("user/book_wines.ejs",{"wine_data":wine_data,"hotel_data":hotel_data})
})
